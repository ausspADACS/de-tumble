...
%% ***INPUTS***
sim_time = 96; %minutes in simulation
    %95.63 = 1 orbit
time_step = 1; %seconds between data sample--use numbers below 1
    %DO NOT SET BELOW 0.01 LEST YOU WISH TO MEET THE KRAKEN
k = -300000; %B-dot gain value for de-tumble
...
ang_vel(1,:) = [20 -20 -10];%Initial angular velocity at deployment, dps
...
for j = 1:size(B_field_orb, 1)
    ...
    ang_accel(j,:) = (momInertiaMatrix\(torque(j,:)'))';%(invMomInertiaMatrix*torque(j,:)')';
